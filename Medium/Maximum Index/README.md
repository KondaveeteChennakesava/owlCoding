<h2><a href="https://www.geeksforgeeks.org/problems/maximum-index-1587115620/1">Maximum Index</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p class=""><span style="font-size: 14pt;" class="">Given an array <strong>a</strong> of <strong>n</strong> positive integers. The task is to&nbsp;find the maximum of <strong>j - i</strong> subjected to the constraint of <strong class="">a[i] <u class="">&lt;</u> a[j] </strong>and <strong>i <u>&lt;</u>&nbsp;j</strong>.</span></p>
<p class=""><span style="font-size: 14pt;"><strong>Example 1:</strong></span></p>
<pre class=""><span style="font-size: 14pt;"><strong>Input:
</strong>n = 2
a[] = {1, 10}
<strong>Output:
</strong>1<strong>
...
<p class=""><span style="font-size: 14pt;"><strong>Example 2:</strong></span></p>
<pre class=""><span style="font-size: 14pt;"><strong>Input:
</strong>n = 9
...
<p class=""><span style="font-size: 14pt;"><strong>Expected Time Complexity:&nbsp;</strong>O(N)<br><strong>Expected Auxiliary Space:&nbsp;</strong>O(N)</span></p>
<p class=""><span style="font-size: 14pt;" class=""><strong>Constraints:</strong><br>1 ≤ n ≤ 10<sup class="">6</sup><br>0 ≤ a[i] ≤ 10<sup>9</sup></span></p></div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>VMWare</code>&nbsp;<code>Amazon</code>&nbsp;<code>Microsoft</code>&nbsp;<code>MakeMyTrip</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;<code>Data Structures</code>&nbsp;